...
//uses the -9 to make somekind of equation
...
const GameBoard = () => {
    ...
    const handleCellClick = async (e) => {
        ...
        if(!winner){
            //targets the tile by id? when there is a winner, this is how it knows which tiles are the winner.
            ...
            //Just an alert for a double click.
